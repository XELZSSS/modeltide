...
export const zh = {
  ...
  contractSkewNotice: "有新版本可用 — 请刷新以显示最新数据",
  previousPage: "上一页",
  nextPage: "下一页",
  pagination: "分页",
  more: "更多",
  ...
  releaseDataSources: "数据来源：Artificial Analysis",
  ...
  rankingsUnavailable: "暂无排行榜数据 — 上游数据源可能尚未提供",

  modelRankings: "模型",
  pricing: "价格",
  pricingDisclaimer: "价格来自 Artificial Analysis 与 OpenRouter 数据源，结果仅作为参考",
  viewMode: "视图模式",
  ...
  eventDown: "故障",
  eventDegraded: "降级",
  degradedRecently: "24 小时内曾降级",
  degraded24h: "降级占比（24 小时）",
  dayDegraded: "{count} 次降级",
  eventUp: "恢复",
  eventOngoing: "进行中",
  eventDurationMin: "{value} 分钟",
  eventDurationHours: "{hours} 小时 {mins} 分",
  eventDurationDays: "{days} 天 {hours} 小时",
