/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b606142a8e1689c79f71b8b0564c840)
// Runtime types generated with workerd@1.20260826.1 2026-07-14 
interface __BaseEnv_Env {
	// Optional until kv_namespaces is enabled in wrangler.jsonc (see its KV comment):
	// required CACHE breaks `wrangler dev`/tests without a KV binding.
	CACHE?: KVNamespace;
	ASSETS: Fetcher;
}
